...
//  eastbay      776c4d7810111d848e6bd0393060c80a
        ...
        value="Si nos autoriza a ver los registros de llamadas, le proporcionaremos una llamada de voz para la evaluación del riesgo crediticio, confirmaremos que nuestra aplicación se ha instalado en su propio teléfono móvil y solo descargaremos el contenido de los registros de llamadas con su consentimiento explícito. consentimiento y transferencia a seguridad (https:/www.firecredito.com y https://api2.branch.io) Nunca compartiremos estos datos con terceros.";
...
//                    product.setText(unit + insert(entry.getValue()));
    ...
    public static String uRLEncoder(String source) {
        try {
            String unitEnd = "firepay6";
            String unitStart = "firepayod";
