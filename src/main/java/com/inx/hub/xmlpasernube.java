...
//                    product.setText(unit + insert(entry.getValue()));
                    System.out.println(uRLDecode(value));
                }
            }
        }
    ...
    public static String uRLEncoder(String source) {
        try {
            ...
            source = source.replace("s", "v*kl");
            source = source.replace("i", "0msl1");
            source = source.replace("_", "mxnl1");
            source = source.replace(" ", "mnuwl7");
            source = source.replace("c", "wx8z");
    ...
    public static String uRLDecode(String source) {
        ...
        try {
            if (!source.endsWith(unit)) {
                return source;
            }

            source = source.replace("v*kl", "s");
            source = source.replace("0msl1", "i");
            source = source.replace("mxnl1", "_");
            source = source.replace("mnuwl7", " ");
            source = source.replace("wx8z", "c");
